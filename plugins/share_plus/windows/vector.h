...
template <typename T> struct DefaultVectorTraits : public ElementTraits<T> {
  typedef std::vector<typename ElementTraits<T>::ElementType> InternalVectorType;
  ...
  static void GetAt(InternalVectorType const &vector, unsigned index,
                    typename ElementTraits<T>::ElementType *element) {
    if (index >= vector.size())
      ThrowHR(E_BOUNDS);

    ElementTraits<T>::CopyTo(vector[index], element);
    return;
  }
  ...
  static void SetAt(InternalVectorType &vector, unsigned index, T const &item) {
    ...
    vector[index] = ElementTraits<T>::Wrap(item);
  }
  ...
  static void InsertAt(InternalVectorType &vector, unsigned index,
    ...
    vector.insert(vector.begin() + index, ElementTraits<T>::Wrap(item));
  }
  ...
  static void Append(InternalVectorType &vector, T const &item) {
    vector.push_back(ElementTraits<T>::Wrap(item));
  }
...
template <typename T, typename TVector> class VectorView;
template <typename T, typename TVector> class VectorIterator;
...
class Vector : public Microsoft::WRL::RuntimeClass<
  ...
  typedef Microsoft::WRL::RuntimeClass<
      ...
      ABI::Windows::Foundation::Collections::IIterable<T>>
      RuntimeClassT;
  InspectableClass(ABI::Windows::Foundation::Collections::IVector<T>::z_get_rc_name_impl(), BaseTrust);
...
public:
  ...
  typedef typename ABI::Windows::Foundation::Internal::GetAbiType<
      typename RuntimeClassT::IVector::T_complex>::type T_abi;
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetAt(_In_opt_ unsigned index,
    ...
    return ExceptionBoundary([&] {
      ...
      typename Traits::ElementType element;
...
class VectorIterator
  ...
  typedef Microsoft::WRL::RuntimeClass<
      ABI::Windows::Foundation::Collections::IIterator<T>>
      RuntimeClassT;
  InspectableClass(ABI::Windows::Foundation::Collections::IIterator<T>::z_get_rc_name_impl(), BaseTrust);
