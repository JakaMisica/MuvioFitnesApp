...
const ChatSessionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'mode': PropertySchema(
      ...
      enumMap: _ChatSessionmodeEnumValueMap,
    ),
...
void _chatSessionSerialize(
  ...
  writer.writeString(offsets[1], object.mode.name);
...
const _ChatSessionmodeEnumValueMap = {
  r'general': r'general',
  r'diet': r'diet',
  r'workout': r'workout',
};
const _ChatSessionmodeValueEnumMap = {
  r'general': AiMode.general,
  r'diet': AiMode.diet,
  r'workout': AiMode.workout,
};
...
extension ChatSessionQueryFilter
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterFilterCondition> modeEqualTo(
    AiMode value, {
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterFilterCondition> modeGreaterThan(
    AiMode value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterFilterCondition> modeLessThan(
    AiMode value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterFilterCondition> modeBetween(
    AiMode lower,
    AiMode upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterFilterCondition> modeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterFilterCondition> modeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ChatSessionQuerySortBy
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterSortBy> sortByLastMessageTime() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterSortBy> sortByMode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mode', Sort.asc);
    });
  }

  QueryBuilder<ChatSession, ChatSession, QAfterSortBy> sortByModeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatSessionQuerySortThenBy
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterSortBy> thenByLastMessageTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastMessageTime', Sort.asc);
    });
  }
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterSortBy> thenByMode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mode', Sort.asc);
    });
  }

  QueryBuilder<ChatSession, ChatSession, QAfterSortBy> thenByModeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mode', Sort.desc);
    });
  }
...
extension ChatSessionQueryProperty
  ...
  QueryBuilder<ChatSession, AiMode, QQueryOperations> modeProperty() {
    return QueryBuilder.apply(this, (query) {
