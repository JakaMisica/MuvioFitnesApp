    ...
    return StreamBuilder<TutorialStep?>(
      ...
      builder: (context, snapshot) {
        ...
        return Stack(
          children: [
            widget.child,
            Positioned.fill(child: _TutorialOverlayContent(step: step)),
          ],
        );
      },
    );
  ...
  Widget _buildStepContent(
    ...
    switch (step) {
      case TutorialStep.welcome:
        ...
        description = "Welcome to your Muvio dashboard.";
        break;
      case TutorialStep.rewardMetrics:
        title = "YOUR REWARDS";
        description = "Track Muscle Points and Coins.";
        break;
      case TutorialStep.measurements:
        title = "METRIC LOG";
        description = "Log measurements to track changes.";
        break;
      case TutorialStep.gainsAnalytics:
        title = "VOLUME ANALYTICS";
        description = "Track session volume trends.";
        break;
      case TutorialStep.gainsBox:
        title = "MUSCLE GAINS";
        description = "Click to see gains distribution.";
        break;
      case TutorialStep.weightBox:
        title = "WEIGHT LOGGING";
        description = "Log weight daily in the morning!";
        break;
      case TutorialStep.bodyFatBox:
        title = "BODY FAT %";
        description = "Monitor body composition changes.";
        break;
      case TutorialStep.expandMetrics:
        title = "REVEAL MORE";
        description = "Click this button to see Grip Strength.";
        break;
      case TutorialStep.gripBox:
        title = "GRIP STRENGTH";
        description = "Indicator of overall vitality.";
        break;
      case TutorialStep.swipeToWorkout:
        title = "HEADING TO WORKOUT";
        description = "Hold tight, shifting environments...";
        break;
      case TutorialStep.startWorkout:
        title = "BEGIN PROTOCOL";
        description = "Press Start Workout to begin your session.";
        break;
      case TutorialStep.firstExercise:
        title = "SELECT DRILL";
        description = "Choose your first exercise to log.";
        break;
      case TutorialStep.addExerciseToDay:
        title = "LOG ACTIVITY";
        description = "Click again to add it to your schedule.";
        break;
      case TutorialStep.restTimerTag:
        title = "REST MANAGEMENT";
        description = "Tap the rest timer to adjust your recovery.";
        break;
      case TutorialStep.increaseRestTime:
        title = "EXTEND RECOVERY";
        description = "Add seconds to your rest window.";
        break;
      case TutorialStep.saveRestTime:
        title = "SAVE SETTINGS";
        description = "Confirm your new rest duration.";
        break;
      case TutorialStep.tutTag:
        title = "TEMPO TRACKING";
        description = "Adjust Time Under Tension if needed.";
        break;
      case TutorialStep.prepTimeTag:
        title = "PREP WINDOW";
        description = "Adjust preparation time before sets.";
        break;
      case TutorialStep.exerciseOptions:
        title = "LOG OPTIONS";
        description = "More tools for precise logging.";
        break;
      case TutorialStep.rirOption:
        title = "EXERTION LEVEL";
        description = "Tap RIR to log Reps in Reserve.";
        break;
      case TutorialStep.typeRir:
        title = "NEURAL INPUT";
        description = "Type '2' to set your target intensity.";
        break;
      case TutorialStep.saveRir:
        title = "INTENSITY SAVED";
        description = "Confirm and proceed.";
        break;
      case TutorialStep.addSet:
        title = "VOLUME EXPANSION";
        description = "Add a new set to your workout.";
        break;
      case TutorialStep.logSet:
        title = "SECURE LOG";
        description = "Click the checkmark to record this set.";
        break;
      case TutorialStep.startRestTimer:
        title = "IGNITE RECOVERY";
        description = "Press Start to begin the rest countdown.";
        break;
      case TutorialStep.finishRestTimer:
        title = "RECOVERY COMPLETE";
        description = "Finish the timer and move to next set.";
        break;
      case TutorialStep.exerciseGraph:
        title = "PERFORMANCE CHART";
        description = "Analyze your strength trends.";
        break;
      case TutorialStep.skipRestTimer:
        title = "BYPASS REST";
        description = "Skip the rest timer to proceed faster.";
        break;
      case TutorialStep.swipeToCoach:
        title = "CONSULTING COACH";
        description = "Transitioning to AI advisory mode...";
        break;
      case TutorialStep.coachWait:
        title = "NEURAL ANALYSIS";
        description = "The AI Coach is optimizing your protocol...";
        break;
      case TutorialStep.swipeToSocial:
        title = "ENTERING HUB";
        description = "Sychronizing with the social network...";
        break;
      case TutorialStep.squadItem:
        title = "THE SQUAD";
        description = "Select the Hypertrophy Squad to view activity.";
        break;
      case TutorialStep.squadDetailsIcon:
        title = "SQUAD PORTAL";
        description = "Tap for shared knowledge and tools.";
        break;
      case TutorialStep.workoutPlanButton:
        title = "COLLECTIVE PLAN";
        description = "Access shared training protocols.";
        break;
      case TutorialStep.swipeToFinish:
        title = "PROTOCOL COMPLETE";
        description = "Returning to dashboard. Training initiated.";
        break;
      case TutorialStep.completed:
        title = "YOU ARE READY";
        description = "Proceed to maximum performance.";
        break;
      default:
        break;
    }
    ...
    Future.delayed(const Duration(seconds: 3), () {
      if (_service.currentStep == TutorialStep.swipeToWorkout) {
        try {
          final pc = context.read<PageController>();
          pc
              .animateToPage(5, duration: 1200.ms, curve: Curves.easeInOutCubic)
              .then((_) => _service.finish());
        } catch (e) {
          _service.finish();
        }
      }
