    ...
    return BlocListener<SleepCubit, SleepState>(
      ...
      child: BlocBuilder<SleepCubit, SleepState>(
        builder: (context, state) {
          final snoozeDuration = _tempSnoozeMinutes ?? state.snoozeDurationMinutes;
                          ...
                          builder: (context, child) {
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: Colors.cyanAccent.withOpacity(0.3 + (0.4 * _pulseController.value)),
                                  width: 2,
                                ),
                                boxShadow: [
                                  BoxShadow(
                                  ...
                                  BoxShadow(
                                    color: Colors.purpleAccent.withOpacity(0.1 * (1 - _pulseController.value)),
                                    blurRadius: 60,
                                    spreadRadius: 5,
                                  ),
                                ],
                            ...
                            Row(
                              ...
                              children: [5, 10, 15, 30, 45].map((m) {
                                ...
                                return GestureDetector(
                                  onTap: () => setState(() => _tempSnoozeMinutes = m),
